...
import { default as ConnectionQueueItem } from "./ConnectionQueueItem";
...
export default class ConnectionQueue {
   ...
   */
  tail() {
    return new ConnectionQueue(this.connections.delete(0));
  }
   ...
   */
  dequeue(connection) {
    var index = this.connections.findIndex(v =>
